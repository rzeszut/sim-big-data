...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.5]{obrazki/HDFS architecture.png}}
...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.5]{obrazki/wysokopoziomowa architektura hadoop.png}}
