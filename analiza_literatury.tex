...
Do przeprowadzania symulacji komputerowej stosuje si� narz�dzia takie jak SciLab \cite{www:scilab}, j�zyk programowania GPSS \cite{www:gpss} oraz @Risk \cite{www:risk}.
